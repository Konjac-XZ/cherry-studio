...
describe('options utils', () => {
  ...
  describe('buildProviderOptions', () => {
    ...
    describe('Proxy provider custom parameters mapping', () => {
      ...
      it('should append qwen quick-model overrides through buildProviderOptions', async () => {
        const { getCustomParameters } = await import('../reasoning')
      ...
      it('should append doubao quick-model overrides as reasoningEffort', async () => {
        const { getCustomParameters } = await import('../reasoning')
      ...
      it('should append glm quick-model overrides through buildProviderOptions', async () => {
        const { getCustomParameters } = await import('../reasoning')
